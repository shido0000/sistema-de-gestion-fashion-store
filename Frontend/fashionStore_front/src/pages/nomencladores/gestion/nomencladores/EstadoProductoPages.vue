<template>
    <div class="q-pa-xl">
        <q-breadcrumbs class="qb cursor-pointer q-pb-md">
            ...
            <q-breadcrumbs-el label="EstadoProducto" />
        </q-breadcrumbs>
...
<script setup>
// IMPORT LIBRERIES
import { dataColumnEstado_Producto } from "src/assets/js/column_data/columnDataGestion";
import {
    loadGet,
    saveData,
    isValorRepetido,
...
// DATOS DE LA TABLA
const columns = dataColumnEstado_Producto;
const filter = ref("");
const items = ref([]);
